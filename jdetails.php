...
<div class="content">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header ">
                            <h4 class="card-title">JOB ENQUIRY</h4>
    ...
    <?php
        $sql="SELECT * from job where volunteer_id='$_GET[id]';";
...
<tr> <th> Address </th><th colspan='3'> <?php echo $row['address'] ?>, <?php echo $row['city'] ?></th> </tr>    

<tr> <th> Email </th><th> <?php echo $row['email'] ?></th>
<th> Contact </th><th> <?php echo $row['contact'] ?></th> </tr>
    <tr> 
    ...
    if(isset($_POST['save'])) 
   {
        ...
        $sql="update job set reply='$txt'  where volunteer_id='$_GET[id]' ;";
        if($conn->query($sql)){
     
$email = 'itzaditijaitley@gmail.com';
$password = 'project@2020';
$to_id=$em;
$to_name=$nm;
$subject='Response to your Job request.';
...
try {
    ...
    $mail->Body    = $message;   
    $mail->send();
    echo"<script>window.alert('DATA SAVED SUCCESSFULLY'); window.location='ourjob.php'; </script>";
} catch (Exception $e) {
