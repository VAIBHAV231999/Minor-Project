                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header ">
                            <h4 class="card-title">BRANCH GALLERY</h4>
                            <p class="card-category">Branch Images </p>
                        </div>
                        <div class="card-body">
...
<div class="col-md-1">
    ...
    if(isset($_POST['save'])) 
    {
      ...
      if($ext=="jpg" or $ext=="jpeg" or $ext=="png" or $ext=="gif" or  $ext=="bmp")
      {
       ...
       {
         $sql="insert into gallery (title,image,post_id,post_type) values('$_POST[title]','$filename','$_GET[id]','branch');";
        if($conn->query($sql))
    ...
    <?php
        echo"<tr>";
        $i=0;
        $sql="SELECT * from gallery where post_id='$_GET[id]' and post_type='branch' order by title ASC;";
        ...
        {   $i++;
         ...
         $pid=$_GET['id'];
           ...
           echo"<td class='text-center'><img src='".$row['image']."'width='70px' height='70px'><br/>";
            ...
            echo"".$row['title']."</td>";
            echo"<td><a href='branch_gallery.php?del=$cid&id=$pid'><i class='icofont-trash'></i></a></td>";
            if($i%6==0)
            echo"</tr><tr>";
        }
    ?> 
     ...
     if(isset($_GET['del'])) 
     {
         ...
         if($conn->query($sql))
         {
             ...
             window.location='branch_gallery.php?id=$pid';</script>";
         }
         else
         {
