...
<h2 class="pt-5 pb-5 " style='font-family:serif'>Article </h2>
...
<div class="col-md-9 ">  
  ...
  <?php
$result=$conn->query("SELECT * from article order by posted_on DESC ;");
...
<div class="col-md-3  text-center">
   ...
   <div class="col-md-9 ">      
        <h4 class="pt-2"> <?php echo $row['article'];?> </h4>
        <h6 class="pt-2 text-muted"> <i class="icofont-calendar text-success"></i> <?php echo $row['posted_on'];?> </h6>
       
       <p class="pt-2 text-justify"> <?php echo substr( strip_tags($row['description']),0,300);?>... 
       <?php  echo"<a href='fullarticle.php?id=$aid' style='color:mediumpurple; text-decoration:none;'>Read More</a>"; ?></p>
         </div></div>
<?php }  ?>
    </div>
