                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header ">
                            ...
                            <p class="card-category">Event Images </p>
                        </div>
                        <div class="card-body">
...
<div class="col-md-1">
    ...
    if(isset($_POST['save'])) 
    {
      ...
      if($ext=="jpg" or $ext=="jpeg" or $ext=="png")
      {
       ...
       {
         $sql="insert into gallery (title,image,post_id,post_type) values('$_POST[title]','$filename','$_GET[id]','event');";
        if($conn->query($sql))
        ...
        {   $i++;
         ...
         $pid=$_GET['id'];
           ...
           echo"<td class='text-center'><img src='".$row['image']."'width='70px' height='70px'><br/>";
            ...
            echo"".$row['title']."</td>";
            echo"<td><a href='event_gallery.php?del=$cid&id=$pid'><i class='icofont-trash'></i></a></td>";
            if($i%6==0)
            echo"</tr><tr>";
        }
    ?> 
     ...
     if(isset($_GET['del'])) 
     {
         ...
         if($conn->query($sql))
         {
             ...
             window.location='event_gallery.php?id=$pid';</script>";
         }
         else
         {
